...
Display::Display(uint8_t _enable, uint8_t _clock, uint8_t _data) {
  ...
  charValue['0.'] = (uint8_t)Digits::_0_;
  charValue['1.'] = (uint8_t)Digits::_1_;
  charValue['2.'] = (uint8_t)Digits::_2_;
  charValue['3.'] = (uint8_t)Digits::_3_;
  charValue['4.'] = (uint8_t)Digits::_4_;
  charValue['5.'] = (uint8_t)Digits::_5_;
  charValue['6.'] = (uint8_t)Digits::_6_;
  charValue['7.'] = (uint8_t)Digits::_7_;
  charValue['8.'] = (uint8_t)Digits::_8_;
  charValue['9.'] = (uint8_t)Digits::_9_;
